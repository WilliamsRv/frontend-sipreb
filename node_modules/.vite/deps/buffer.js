import { __commonJS } from "./chunk-vVXnpExW.js";
import { require_base64_js } from "./base64-js-W8H5gAGS.js";
...
var require_buffer = /* @__PURE__ */ __commonJS({ "node_modules/buffer/index.js": ((exports) => {
	...
	*/
	...
	Buffer.prototype.readUintLE = Buffer.prototype.readUIntLE = function readUIntLE(offset, byteLength$1, noAssert) {
		offset = offset >>> 0;
	...
	Buffer.prototype.readUintBE = Buffer.prototype.readUIntBE = function readUIntBE(offset, byteLength$1, noAssert) {
		offset = offset >>> 0;
		byteLength$1 = byteLength$1 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$1, this.length);
		let val = this[offset + --byteLength$1];
		let mul = 1;
	...
	Buffer.prototype.readIntLE = function readIntLE(offset, byteLength$1, noAssert) {
		offset = offset >>> 0;
		byteLength$1 = byteLength$1 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$1, this.length);
		let val = this[offset];
	...
	Buffer.prototype.readIntBE = function readIntBE(offset, byteLength$1, noAssert) {
		offset = offset >>> 0;
		byteLength$1 = byteLength$1 >>> 0;
		if (!noAssert) checkOffset(offset, byteLength$1, this.length);
		let i = byteLength$1;
	...
	Buffer.prototype.writeUintLE = Buffer.prototype.writeUIntLE = function writeUIntLE(value, offset, byteLength$1, noAssert) {
		value = +value;
		offset = offset >>> 0;
		byteLength$1 = byteLength$1 >>> 0;
		if (!noAssert) {
			const maxBytes = Math.pow(2, 8 * byteLength$1) - 1;
	...
	Buffer.prototype.writeUintBE = Buffer.prototype.writeUIntBE = function writeUIntBE(value, offset, byteLength$1, noAssert) {
		value = +value;
		offset = offset >>> 0;
		byteLength$1 = byteLength$1 >>> 0;
		if (!noAssert) {
	...
	Buffer.prototype.writeIntLE = function writeIntLE(value, offset, byteLength$1, noAssert) {
		value = +value;
		offset = offset >>> 0;
		if (!noAssert) {
			const limit = Math.pow(2, 8 * byteLength$1 - 1);
	...
	Buffer.prototype.writeIntBE = function writeIntBE(value, offset, byteLength$1, noAssert) {
		value = +value;
		offset = offset >>> 0;
		if (!noAssert) {
			const limit = Math.pow(2, 8 * byteLength$1 - 1);
	...
	function checkBounds(buf, offset, byteLength$1) {
		validateNumber(offset, "offset");
		if (buf[offset] === void 0 || buf[offset + byteLength$1] === void 0) boundsError(offset, buf.length - (byteLength$1 + 1));
	}
	function checkIntBI(value, min, max, buf, offset, byteLength$1) {
		if (value > max || value < min) {
			const n = typeof min === "bigint" ? "n" : "";
			let range;
			if (byteLength$1 > 3) if (min === 0 || min === BigInt(0)) range = `>= 0${n} and < 2${n} ** ${(byteLength$1 + 1) * 8}${n}`;
			else range = `>= -(2${n} ** ${(byteLength$1 + 1) * 8 - 1}${n}) and < 2 ** ${(byteLength$1 + 1) * 8 - 1}${n}`;
