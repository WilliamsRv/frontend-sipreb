import { __commonJS, __toESM } from "./chunk-vVXnpExW.js";
import { require_react } from "./react-Bj6hFbvJ.js";
import { require_react_dom } from "./react-dom-CwW9HmWj.js";
...
var Virtualizer = class {
	constructor(opts) {
		...
		], (count$1, paddingStart, scrollMargin, getItemKey, enabled) => {
			this.pendingMeasuredCacheIndexes = [];
			return {
				count: count$1,
				paddingStart,
		...
		this.getMeasurements = memo(() => [this.getMeasurementOptions(), this.itemSizeCache], ({ count: count$1, paddingStart, scrollMargin, getItemKey, enabled }, itemSizeCache) => {
			if (!enabled) {
				this.measurementsCache = [];
			...
			const min$1 = this.pendingMeasuredCacheIndexes.length > 0 ? Math.min(...this.pendingMeasuredCacheIndexes) : 0;
			this.pendingMeasuredCacheIndexes = [];
			...
			for (let i$15 = min$1; i$15 < count$1; i$15++) {
				...
				const lane = furthestMeasurement ? furthestMeasurement.lane : i$15 % this.options.lanes;
				measurements[i$15] = {
					index: i$15,
					start,
					size: size$3,
